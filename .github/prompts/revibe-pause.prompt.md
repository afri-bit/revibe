---
description: End the current Revibe session and persist progress to memory
agent: revibe
---

End this Revibe session cleanly. Before saying goodbye:

1. Update `memory/MEMORY.md`:
   - Update the Active Plan section with the current module and lesson.
